...
How to work on flox-ai: the toolchain, the workflow, testing, and the
build.

| Doc | What it covers |
| ------------------------ | -------------- |
| [environment.md](environment.md) | Getting a shell with the Go toolchain and the audit tools |
