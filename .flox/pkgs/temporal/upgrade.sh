...
echo "Updating temporal from $current_version to $latest_version"

src_url="https://github.com/temporalio/temporal/archive/refs/tags/v${latest_version}.tar.gz"
...
prefetch_log=$(mktemp)
flox build temporal > "$prefetch_log" 2>&1 || true
