{ stdenv, lib, fetchFromGitHub, jq, kotlin-language-server, flox-agent-layout }:
...
in
stdenv.mkDerivation {
  pname = "skills-official-kotlin-lsp";
  ...
  postInstall = ''
    flox-agent-layout --plugin kotlin-lsp --share "$out/share"
  '';
