...
latest_tag=$(curl -sfL \
  https://api.github.com/repos/raine/workmux/releases/latest \
  | jq -r '.tag_name')
...
echo "Updating workmux from $current_version to $latest_version"

src_url="https://github.com/raine/workmux/archive/refs/tags/v${latest_version}.tar.gz"
