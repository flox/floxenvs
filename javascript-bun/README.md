...
<!-- codespaces-badge -->
[![Open in Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/flox/floxenvs?devcontainer_path=.devcontainer%2Fjavascript-bun%2Fdevcontainer.json)
...
```toml
[include]
environments = [{ remote = "flox/javascript-bun" }]
```
