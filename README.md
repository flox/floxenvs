...
| kafka | Apache Kafka | [floxhub](https://hub.flox.dev/flox/kafka) · [docs](kafka/README.md) · [docker](https://github.com/flox/floxenvs/pkgs/container/floxenvs/kafka-latest) · [codespace](https://codespaces.new/flox/floxenvs?devcontainer_path=.devcontainer%2Fkafka%2Fdevcontainer.json) |
| _└ kafka-demo_ | | [floxhub](https://hub.flox.dev/flox/kafka-demo) · [docs](kafka-demo/README.md) · [docker](https://github.com/flox/floxenvs/pkgs/container/floxenvs/kafka-demo-latest) · [codespace](https://codespaces.new/flox/floxenvs?devcontainer_path=.devcontainer%2Fkafka-demo%2Fdevcontainer.json) |
...
| firecrawl | Web scrape / crawl / search CLI + Claude Code skill | [floxhub](https://hub.flox.dev/flox/firecrawl) · [docs](firecrawl/README.md) · [docker](https://github.com/flox/floxenvs/pkgs/container/floxenvs/firecrawl-latest) · [codespace](https://codespaces.new/flox/floxenvs?devcontainer_path=.devcontainer%2Ffirecrawl%2Fdevcontainer.json) |
| _└ firecrawl-demo_ | | [floxhub](https://hub.flox.dev/flox/firecrawl-demo) · [docs](firecrawl-demo/README.md) · [docker](https://github.com/flox/floxenvs/pkgs/container/floxenvs/firecrawl-demo-latest) · [codespace](https://codespaces.new/flox/floxenvs?devcontainer_path=.devcontainer%2Ffirecrawl-demo%2Fdevcontainer.json) |
...
| review-skills | Unified 0-100 score for Claude skills & agents | [floxhub](https://hub.flox.dev/flox/review-skills) · [docs](review-skills/README.md) · [docker](https://github.com/flox/floxenvs/pkgs/container/floxenvs/review-skills-latest) · [codespace](https://codespaces.new/flox/floxenvs?devcontainer_path=.devcontainer%2Freview-skills%2Fdevcontainer.json) |
| _└ review-skills-demo_ | | [floxhub](https://hub.flox.dev/flox/review-skills-demo) · [docs](review-skills-demo/README.md) · [docker](https://github.com/flox/floxenvs/pkgs/container/floxenvs/review-skills-demo-latest) · [codespace](https://codespaces.new/flox/floxenvs?devcontainer_path=.devcontainer%2Freview-skills-demo%2Fdevcontainer.json) |
