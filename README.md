...
| sana | NVIDIA SANA text-to-image inference | [floxhub](https://hub.flox.dev/flox/sana) · [docs](sana/README.md) · [docker](https://github.com/flox/floxenvs/pkgs/container/floxenvs/sana-latest) |
| _└ sana-demo_ | | [floxhub](https://hub.flox.dev/flox/sana-demo) · [docs](sana-demo/README.md) · [docker](https://github.com/flox/floxenvs/pkgs/container/floxenvs/sana-demo-latest) |
